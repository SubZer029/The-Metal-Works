...
public class TileEntityTitaniumFurnace extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.localizedName : "container.TitaniumFurnace";
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                TitaniumFurnace.updateTitaniumFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.yCoord, this.zCoord);
            }
        }
