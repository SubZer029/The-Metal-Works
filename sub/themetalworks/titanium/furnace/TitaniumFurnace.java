...
public class TitaniumFurnace extends BlockContainer
{
    ...
    public TitaniumFurnace(int id, boolean isActive)
    {
    ...
    {
        this.blockIcon = iconRegister.registerIcon(TheMetalWorksHub.modid + ":" + "titanium_furnace_side");
        this.iconFront = iconRegister.registerIcon(TheMetalWorksHub.modid + ":" + (this.isActive ? "titanium_furnace_front_on" : "titanium_furnace_front_off"));
    }
    ...
    {
        return TheMetalWorksHub.TitaniumFurnaceIdle.blockID;
    }
    		...
    		EntityPlayer player, int side, float hitX, float hitY, float hitZ)
    {
        if (!world.isRemote)
        {
            FMLNetworkHandler.openGui(player, TheMetalWorksHub.instance1, TheMetalWorksHub.guiIdTitaniumFurnace, world, x, y, z);
        }
    ...
    public static void updateTitaniumFurnaceBlockState(boolean active, World worldObj, int xCoord, int yCoord, int yCoord2, int zCoord)
    {
        ...
        if (active)
        {
            worldObj.setBlock(xCoord, yCoord, zCoord, TheMetalWorksHub.TitaniumFurnaceActive.blockID);
        }
        else
        {
            worldObj.setBlock(xCoord, yCoord, zCoord, TheMetalWorksHub.TitaniumFurnaceIdle.blockID);
        }
