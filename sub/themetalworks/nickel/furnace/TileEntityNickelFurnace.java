...
public class TileEntityNickelFurnace extends TileEntity implements ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.localizedName : "container.nickelFurnace";
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                NickelFurnace.updateNickelFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.yCoord, this.zCoord);
            }
        }
